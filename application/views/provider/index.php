<div class="container-fluid">
            ...
            <div class="d-flex align-items-center">
                ...
                <div>
                    <div class="page-header-tools">
                        <a class="btn btn-gradient-01" href="<?= base_url("tambah_provider")?>">Tambah Provider</a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="table-responsive">
                        <table id="sorting-table" class="table mb-0">
                            ...
                            <tr>
                                ...
                                <td class="td-actions">
                                    <a href="<?= base_url("edit_provider/".$key->provider_id)?>"><i class="la la-edit edit"></i></a>
                                    <a onclick="return confirm('Apakah anda yakin ingin menghapus data ini?')" href="<?= base_url("delete_provider/".$key->provider_id)?>"><i class="la la-close delete"></i></a>
                                </td>
                            </tr>
                            <?php }?>
    ...
    <div id="modal_provider" class="modal fade">
