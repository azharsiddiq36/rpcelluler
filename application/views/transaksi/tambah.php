        ...
        <div class="col-xl-12">
            ...
            <div class="widget has-shadow">
                ...
                <div class="widget-body">
                    <form class="needs-validation" action="<?= base_url("tambah_transaksi")?>" method="post" novalidate>
                        <div class="form-group row d-flex align-items-center mb-5">
                            <label class="col-lg-4 form-control-label d-flex justify-content-lg-end">Nama</label>
                            <div class="col-lg-5">
                                <input type="text" class="form-control" name = "transaksi_nama" placeholder="Masukkan Nama" required>
